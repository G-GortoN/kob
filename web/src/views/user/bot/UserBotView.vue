                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <VAceEditor v-model:value="bot_add.content" @init="editorInit" lang="c_cpp"
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" style="margin-right: 20px" data-bs-toggle="modal" :data-bs-target="'#update-bot-modal-' + bot.id">修改</button>
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app6506.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app6506.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: bot_add.title,
        ...
        const update_bot = (bot) => {
            bot_add.error_message = "";
            $.ajax({
                url: "https://app6506.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app6506.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
